...
Load the rule for the task at hand. Each file is self-contained.

| Task | Rule file |
|------|-----------|
| Adding new syntax (token, AST node, statement, expression) | `.claude/rules/add-syntax.md` |
| Adding a built-in Rust function | `.claude/rules/add-builtin.md` |
| Adding an Aether stdlib function | `.claude/rules/add-stdlib.md` |
...
| Writing any `.rs` file | `.claude/rules/rust-style.md` |
