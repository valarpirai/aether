...
fn test_builtin_type() {
    assert_eq!(builtin_type(&[Value::Int(42)]).unwrap(), Value::string("int"));
    assert_eq!(builtin_type(&[Value::Float(3.14)]).unwrap(), Value::string("float"));
    assert_eq!(builtin_type(&[Value::Bool(true)]).unwrap(), Value::string("bool"));
    assert_eq!(builtin_type(&[Value::string("hi")]).unwrap(), Value::string("string"));
}
...
fn test_builtin_int_conversions() {
    ...
    assert_eq!(builtin_int(&[Value::string("123")]).unwrap(), Value::Int(123));
...
fn test_builtin_float_conversions() {
    ...
    assert_eq!(builtin_float(&[Value::string("3.14")]).unwrap(), Value::Float(3.14));
}
...
fn test_builtin_bool_conversions() {
    ...
    assert_eq!(builtin_bool(&[Value::string("")]).unwrap(), Value::Bool(false));
    assert_eq!(builtin_bool(&[Value::string("hi")]).unwrap(), Value::Bool(true));
